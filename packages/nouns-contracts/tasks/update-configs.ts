  ...
  .setAction(
    async (
      ...
      addresses[chainId] = {
        ...
        nounsDAOProxy: contracts.NounsDAOProxyV1.address,
      ...
      const subgraphConfig = {
        ...
        nounsDAO: {
          address: contracts.NounsDAOProxyV1.address,
          startBlock: contracts.NounsDAOProxyV1.instance.deployTransaction.blockNumber,
        },
      };
