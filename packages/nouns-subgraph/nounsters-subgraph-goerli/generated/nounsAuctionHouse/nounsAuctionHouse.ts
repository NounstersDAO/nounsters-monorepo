...
export class nounsAuctionHouseOwnershipTransferred extends ethereum.Event {
  get params(): nounsAuctionHouseOwnershipTransferred__Params {
    return new nounsAuctionHouseOwnershipTransferred__Params(this);
  }
}

export class nounsAuctionHouseOwnershipTransferred__Params {
  _event: nounsAuctionHouseOwnershipTransferred;

  constructor(event: nounsAuctionHouseOwnershipTransferred) {
    this._event = event;
  }
